...
$(window).load(function() {
  ...
  let json = api.boa.run('deadcode-detector.boa');
  $('#loading').hide();
  $('#content').show();
  ...
  $('#app-title').html(`Number of Deadcode locations in ${instance.repos.name}`);
